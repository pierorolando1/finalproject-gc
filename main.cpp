...
void setupTexture(Texture* texture)
{
  ...
  void drawBoundingCube(float xMin, float xMax, float yMin, float yMax, float zMin, float zMax) {
      glPushMatrix();
  ...
  bool bedsideSelected = false;
  bool camaSelected = false;
  bool sillaSelected = false;
  bool mesaVentiladorSelected = false;
  bool mesaMonitorSelected = false;
  ...
  void display(void)
  {
      ...
      // Bedside table
      glPushMatrix();
          if(bedsideMesh.position.size() == 0){
              bedsideMesh.position = {2, 0, -10};
          }
          glTranslatef(bedsideMesh.position[0], bedsideMesh.position[1], bedsideMesh.position[2]);
          glRotatef(180, 0, 1, 0);
          ...
          if (bedsideSelected) {
              bedsideLoader.LoadedMeshes[0].drawBoundingBox();
              //drawBoundingCube(bedsideMesh.minX, bedsideMesh.maxX, bedsideMesh.minY, bedsideMesh.maxY, bedsideMesh.minZ, bedsideMesh.maxZ);
          }
      ...
      // Cactus
      glPushMatrix();
          if(cactusMesh.position.size() == 0){
              cactusMesh.position = {2, 2.4, -10};
          }
          glTranslatef(cactusMesh.position[0], cactusMesh.position[1], cactusMesh.position[2]);
          glRotatef(-90, 1, 0, 0);
          ...
          if(bedsideSelected) {
              cactusLoader.LoadedMeshes[0].drawBoundingBox();
          }
          ...
          glPushMatrix();
              ...
              if(bedsideSelected) {
                  cactusLoader.LoadedMeshes[1].drawBoundingBox();
              }
          glPopMatrix();
      ...
      // Mouse and Mousepad
      glPushMatrix();
          if(mouseMesh.position.size() == 0){
              mouseMesh.position = {17, 3.32, -18};
          }
          glTranslatef(mouseMesh.position[0], mouseMesh.position[1], mouseMesh.position[2]);
          glRotatef(-90, 1, 0, 0);
          ...
          if(mesaMonitorSelected) {
              mouseLoader.LoadedMeshes[0].drawBoundingBox();
          }
      ...
      // Keyboard
      glPushMatrix();
          if(keyboardMesh.position.size() == 0){
              keyboardMesh.position = {15, 3.3, -18};
          }
          glTranslatef(keyboardMesh.position[0], keyboardMesh.position[1], keyboardMesh.position[2]);
          glRotatef(-90, 1, 0, 0);
          ...
          if(mesaMonitorSelected) {
              keyboardLoader.LoadedMeshes[0].drawBoundingBox();
          }
          ...
          glPushMatrix();
              ...
              if(mesaMonitorSelected) {
                  keyboardLoader.LoadedMeshes[1].drawBoundingBox();
              }
          glPopMatrix();
      glPopMatrix();
      ...
      // Monitor
      glPushMatrix();
          if (monitorMesh.position.size() == 0) {
              monitorMesh.position = {17, 3.3, -19};
          }
          glTranslatef(monitorMesh.position[0], monitorMesh.position[1], monitorMesh.position[2]);
          glRotatef(-90, 1, 0, 0);
          ...
          if(mesaMonitorSelected) {
              monitorLoader.LoadedMeshes[0].drawBoundingBox();
          }
      ...
      // Fan
      glPushMatrix();
          if(fanMesh.position.size() == 0){
              fanMesh.position = {1.8, 4.25, -17.3};
          }
          glEnableClientState(GL_VERTEX_ARRAY);
          glEnableClientState(GL_NORMAL_ARRAY);

          glPushMatrix();
              glTranslatef(fanMesh.position[0], fanMesh.position[1], fanMesh.position[2]); 
              // glRotatef(30, 0, 1, 0);
              glRotatef(-90, 1, 0, 0);
              ...
              if(mesaVentiladorSelected) {
                  //fanLoader.LoadedMeshes[0].drawBoundingBox();
              }
          glPopMatrix();
          ...
          glPushMatrix();
              ...
              if(mesaVentiladorSelected) {
                  fanLoader.LoadedMeshes[1].drawBoundingBox();
              }
          glPopMatrix();
      glPopMatrix();
      ...
      // Chair
      glPushMatrix();
          if(chairMesh.position.size() == 0){
              chairMesh.position = {16, 0, -15};
          }
          if (chairSeatMesh.position.size() == 0) {
              chairSeatMesh.position = {0, 0, 0};
          }
          glTranslatef(chairMesh.position[0], chairMesh.position[1], chairMesh.position[2]);
          glRotatef(-170, 0, 1, 0);
          glRotatef(-90, 1, 0, 0);
          ...
          if(sillaSelected) {
              chairLoader.LoadedMeshes[0].drawBoundingBox();
          }

          glPushMatrix();

              glTranslatef(chairSeatMesh.position[0], chairSeatMesh.position[1], chairSeatMesh.position[2]);
              ...
              if(sillaSelected) {
                  chairLoader.LoadedMeshes[1].drawBoundingBox();
              }
      ...
      // Seat
      glPushMatrix();
          if(baseSeatMesh.position.size() == 0){
              baseSeatMesh.position = {1, 0, -roomWidth + 1};
          }
          glEnable(GL_NORMALIZE);
          glDisable( GL_CULL_FACE );
          glShadeModel(GL_SMOOTH);

          glTranslatef(baseSeatMesh.position[0], baseSeatMesh.position[1], baseSeatMesh.position[2]);
          glRotatef(-90, 1, 0, 0);
          glScalef(0.15, 0.15, 0.15);
      ...
      glPushMatrix();
          if(bedMesh.position.size() == 0){
              bedMesh.position = {12, -3.1, -4};
          }
          if(bedMattressMesh.position.size() == 0){
              bedMattressMesh.position = {0, 0, 0};
          }
          if(bedPillowMesh.position.size() == 0){
              bedPillowMesh.position = {0, 0, 0};
          }
          glTranslatef(bedMesh.position[0], bedMesh.position[1], bedMesh.position[2]);
          glRotatef(-90, 0, 1, 0);
          ...
          // glFlush();
          if(camaSelected){
            bedLoader.LoadedMeshes[0].drawBoundingBox();
          }

          glPushMatrix();
              glTranslatef(bedMattressMesh.position[0], bedMattressMesh.position[1], bedMattressMesh.position[2]);
              glEnable(GL_TEXTURE_2D);
              glTexEnvf(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, GL_DECAL);
              ...
              if(camaSelected){
                bedLoader.LoadedMeshes[1].drawBoundingBox();
              }

          glPopMatrix();

          glPushMatrix();
              glTranslatef(bedPillowMesh.position[0], bedPillowMesh.position[1], bedPillowMesh.position[2]);
              ...
              if(camaSelected){
                bedLoader.LoadedMeshes[2].drawBoundingBox();
              }
          glPopMatrix();
  ...
  void keyboard (unsigned char key, int x, int y)
  {
      switch (key) {
          case '1':
              bedsideSelected = !bedsideSelected;
              break;
          ...
          case '3':
              sillaSelected = !sillaSelected;
              break;

          case '4':
              mesaVentiladorSelected = !mesaVentiladorSelected;
              break;
          case '5':
              mesaMonitorSelected = !mesaMonitorSelected;
              break;
          ...
          case 'h':
              if(bedsideSelected){
                  bedsideMesh.position[0] -= 0.1;
                  cactusMesh.position[0] -= 0.1;
              } else if(sillaSelected){
                  chairMesh.position[0] -= 0.1;
                  chairSeatMesh.position[0] -= 0.1;
              } else if(camaSelected){
                  bedMesh.position[0] -= 0.1;
                  bedMattressMesh.position[0] -= 0.1;
                  bedPillowMesh.position[0] -= 0.1;
              } else if (mesaVentiladorSelected){
                  fanMesh.position[0] -= 0.1;
                  baseSeatMesh.position[0] -= 0.1;
              } else if (mesaMonitorSelected){
                  monitorMesh.position[0] -= 0.1;
                  keyboardMesh.position[0] -= 0.1;
                  mouseMesh.position[0] -= 0.1;
              }
              break; 
      
          case 'b':
            if(bedsideSelected){
                bedsideMesh.position[0] += 0.15;
                cactusMesh.position[0] += 0.15;
            } else if (sillaSelected){

                chairMesh.position[0] += 0.15;
                chairSeatMesh.position[0] += 0.15;
            } else if(camaSelected){
                bedMesh.position[0] += 0.15;
                bedMattressMesh.position[0] += 0.15;
                bedPillowMesh.position[0] += 0.15;
            } else if (mesaVentiladorSelected){
                
                baseSeatMesh.position[0] += 0.15;
                fanMesh.position[0] += 0.15;
            } else if (mesaMonitorSelected){
                
                monitorMesh.position[0] += 0.15;
                keyboardMesh.position[0] += 0.15;
                mouseMesh.position[0] += 0.15;
            }
            break;

        case 'n':
            if(bedsideSelected){
                bedsideMesh.position[2] -= 0.15;
                cactusMesh.position[2] -= 0.15;
            } else if (sillaSelected){
                chairMesh.position[2] -= 0.15;
                chairSeatMesh.position[2] -= 0.15;
            } else if(camaSelected){
                bedMesh.position[2] -= 0.15;
                bedMattressMesh.position[2] -= 0.15;
                bedPillowMesh.position[2] -= 0.15;
            } else if (mesaVentiladorSelected){
                fanMesh.position[2] -= 0.15;
                baseSeatMesh.position[2] -= 0.15;
            } else if (mesaMonitorSelected){
                monitorMesh.position[2] -= 0.15;
                keyboardMesh.position[2] -= 0.15;
                mouseMesh.position[2] -= 0.15;
            }
            break;
        case 'm':
            if(bedsideSelected){
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("Trabajo Final - CG");
